<template>
    ...
    <div id="exchangeSection">
        ...
        <div class="faqContainer sectionCenteredWidth">
			...
			Although the developers team worked at their own exchange in the first place to prepare the implementation code for the new exchanges and secondly to have a first exchange, then to develop the code in general, here is someone in the community has already listed the WebDollar cryptocurrency on its small exchange gymbase.io.
            Soon it will be listed on Top 15 CryptoExchange from CMC - p2pb2b.io
            Then listed on the biggest CryptoExchange in the world.
