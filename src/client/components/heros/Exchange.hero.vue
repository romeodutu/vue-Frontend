<template>
    ...
    <div id="exchangeSection">
        ...
        <div class="faqContainer sectionCenteredWidth">
			...
			Although the developers team worked at their own exchange in the first place to prepare the implementation code for the new exchanges and secondly to have a first exchange, then to develop the code in general, here is someone in the community has already listed the WebDollar cryptocurrency on its small exchange <a href="https://gymbase.io" title="CryptoExchange Gymbase">gymbase.io</a>.
            On 20 March 2019 WebDollar was listed on Top 15 CryptoExchange from CMC - <a href="https://p2pb2b.io" title="CryptoExchange P2pb2b">p2pb2b.io</a>.
